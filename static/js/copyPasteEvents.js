...
const saveComments = (comments) => {
  ...
  const mapOriginalCommentsId = pad.plugins.md_comments.mapOriginalCommentsId;
  const mapFakeComments = pad.plugins.md_comments.mapFakeComments;
  ...
  pad.plugins.md_comments.saveCommentWithoutSelection(padId, commentsToSave);
};
...
const saveReplies = (replies) => {
  ...
  pad.plugins.md_comments.saveCommentReplies(padId, repliesToSave);
};
